...
#[cfg(feature = "vsock")]
use {crate::vsock::stream::VsockStream, virtio_drivers::device::socket::VMADDR_CID_HOST};
...
impl Transport<'_> {
    ...
    fn new() -> Self {
        ...
        match VsockStream::connect(1234, VSOCK_ATTEST_DEFAULT_PORT, VMADDR_CID_HOST) {
