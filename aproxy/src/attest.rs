...
pub fn attest(stream: &mut (impl Read + Write), http: &mut backend::HttpClient) -> anyhow::Result<()> {
...
/// parameters.
fn negotiation(stream: &mut (impl Read + Write), http: &mut backend::HttpClient) -> anyhow::Result<()> {
...
fn attestation(stream: &mut (impl Read + Write), http: &mut backend::HttpClient) -> anyhow::Result<()> {
